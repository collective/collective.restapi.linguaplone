...
from collective.restapi.linguaplone.testing import (
    COLLECTIVE_RESTAPI_LINGUAPLONE_FUNCTIONAL_TESTING,
)  # noqa
from collective.restapi.linguaplone.testing import (
    COLLECTIVE_RESTAPI_LINGUAPLONE_INTEGRATION_TESTING,
)  # noqa
...
class TestLPTranslationInfo(TestCase):
    ...
    def setUp(self):
        ...
        lsf = getMultiAdapter(
            (self.portal, self.request), name="language-setup-folders"
        )
        lsf()
